...
<html>
    ...
    <div class="container">
        ...
        <div class="contents">
            <form action="server/banquetRegister.php?bid=<?=$banquet?>" method="POST">
                <div>
                    <h2>Register for <?=$banquetname?></h2>
                </div>
                ...
                <div class="field-group">
                    ...
                    <div class="field">
                        ...
                        <?php
                            while($meal = mysql_fetch_assoc($meal_result))
                            {
                                ?>
                                <div class="radio">        
                                <input type="radio" name="meal" value="<?=$meal['Dish_ID']?>">
                    ...
                    <div class="field">
                        ...
                        <div class="radio-group">
                        <?php
                            while($row6 = mysql_fetch_assoc($drink_result))
                            {
                                ?>
                                <div class="radio">
                                <input type="radio" name="drink" value="<?=$row6['Drink_ID']?>">
                                Drink: <?=$row6['Drink_Name']?></div><br/>
                                <?php
                            }
                        ?>
                        </div>
